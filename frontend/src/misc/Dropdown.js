...
const Dropdown = (props) => {
    ...
    return (
        <div ref = {ref} onClick = {handleClick} className = "relative lg:inline-block w-fit rounded-lg bg-slate-300/20 px-2 py-1 mx-auto my-1 lg:my-0 lg:mx-2">
            ...
            {props.show ? 
            <div className = "absolute bg-stone-600 w-48 border border-stone-700 left-[-1px] rounded-tr-lg rounded-b-lg z-10 p-2">
                {props.children}
            </div> : null }
        </div>
    )
